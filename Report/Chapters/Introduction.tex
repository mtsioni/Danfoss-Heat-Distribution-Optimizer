...
\begin{itemize}
    ...
    \item \textbf{\acrshort{fr}-5:} The system must be able to operate in two distinct opearational scenarios.
...
\begin{itemize}
    ...
    \item \textbf{\acrshort{nfr}-2 (Time Resolution):} All data and calclulations must use a strict 1-hour time resolution.
    ...
    editting configuration files directly.
