...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/AM-InitializeMethod.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/AM-DataForOptimizerMethod.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/GenToOpAd.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/SourceDataManager.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/OP_CalculateHeatPerPrice-methode.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/OP_Sorting-methode.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/OP_Optimize-methode1.png}
    \includegraphics[width=1\textwidth]{Images/OP_Optimize-methode2.png}
